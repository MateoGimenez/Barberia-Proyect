...
export function NavBar() {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 bg-gradient-to-b from-stone-900 to-pink-700 shadow-lg">
      ...
      {/* Menú Mobile */}
      {open && (
        <div className="md:hidden bg-stone-900/95 backdrop-blur-md text-white px-6 py-4 flex flex-col gap-4 shadow-lg">
          <Link
            href="/nosotros"
          ...
          <button className="mt-2 px-5 py-2 rounded-full bg-pink-600 hover:bg-pink-500 transition-colors shadow-md">
            Reservar Cita
          </button>
        </div>
      )}
